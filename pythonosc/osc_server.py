...
def _call_handlers_for_packet(request_handler):
    """
    ...
    data = request_handler.request[0]
    dispatcher = request_handler.server.dispatcher
        ...
        for timed_msg in packet.messages:
            ...
            for handler in handlers:
                if handler.args:
                    ...
                    handler.callback(request_handler, timed_msg.message.address, *timed_msg.message)
...
class _UDPHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        _call_handlers_for_packet(self)
